...
import com.dekhoapp.android.app.base.utils.GlideUtil;
...
//                onBackPressed();
//                break;
                Intent feedsIntent = new Intent(this, CategoryActivity.class);
                startActivity(feedsIntent);
                break;
        }
    }
    ...
    private void handleGoogleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            Log.d(TAG, "Google Sign-In failed." + result.isSuccess());
        }
    }
...
//            onBackPressed();
    ...
    private void showSignedInUI(FirebaseUser firebaseUser) {
        ...
        FirebaseDatabaseUtil.getPeopleRef().child(firebaseUser.getUid()).updateChildren(
                updateValues,
...
//        storageMap.put("Music", "Music");
//        FirebaseDatabaseUtil.getBaseRef().updateChildren(storageMap);
    }
