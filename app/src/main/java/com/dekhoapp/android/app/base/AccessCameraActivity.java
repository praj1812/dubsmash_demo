...
public class AccessCameraActivity extends AppCompatActivity {
    ...
    private String TAG = "AccessCameraActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   setContentView(R.layout.activity_access_camera);
        ...
        uriStr = intent.getSerializableExtra("uriStr").toString();
        ...
        materialCamera.audioDisabled(true);
        Log.d(TAG, "duration ms: " + mp.getDuration());
        materialCamera.countdownMillis(mp.getDuration());
